        ...
        <div>
            ...
            <Container>
                ...
                <Content>
                    ...
                    { columns.sort((a, b) => { return a.order - b.order }).map(column => ( !column.hideCell && getCell(column) )) }
