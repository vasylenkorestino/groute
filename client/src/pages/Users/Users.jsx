...
const Routes = () => {
    ...
    const columns = [
        ...
        { name: 'Email', apiName: 'email', type: 'text', width: 1140, order: 2, modalOrder: 2, hideCell: false },
    ...
    return (
        <div style={{ marginLeft: 30, width: '95%', height: '100%' }} className="d-flex justify-content-center">
