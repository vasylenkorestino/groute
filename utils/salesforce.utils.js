...
const getRoutes = (driverName, dateOfService) => {
    return new Promise((resolve, reject) => {
        ...
        let query = "SELECT Id, RecordType.Name, ServiceType__c, ServiceSubType__c, AccountId__c, Account_Name__c, Container_Address__c, DateOfService__c, Distance_From_Start__c, Driver_Name__c, " +  
